...
> = {
  ...
  Pronto: { label: 'Pronto', color: 'text-emerald-400', glow: 'shadow-[0_0_8px_rgba(52,211,153,0.2)]', bg: 'bg-[rgba(52,211,153,0.06)]', border: 'border-[rgba(52,211,153,0.25)]', btnBg: '', btnLabel: 'Aguardando Pagamento', nextStatus: null },
